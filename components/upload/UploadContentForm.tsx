...
export const UploadContentForm: React.FC<UploadContentFormProps> = ({
  onSuccess,
}) => {
        ...
        <div className="grid md:grid-cols-3 gap-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={handleSelectChange}
              className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 disabled:bg-gray-100 disabled:text-gray-400"
