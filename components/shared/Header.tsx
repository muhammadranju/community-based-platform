      ...
      >
        <div className="max-w-7xl mx-auto px-4 md:px-6">
          <div className="flex h-20 items-center justify-between">
            ...
            {/* Mobile Controls - User Profile on Left, Hamburger on Right */}
            <div className="md:hidden flex items-center gap-3">
              {/* Mobile User Profile Dropdown */}
              {user && (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex items-center gap-2 py-1 px-2 rounded-full hover:bg-gray-100 transition-all duration-200 cursor-pointer">
              ...
              <button
                onClick={toggleMenu}
                className="p-2 text-white z-50 relative bg-orange-600 rounded-lg"
                aria-label="Toggle menu"
              >
                {isMenuOpen ? (
                  <X className="h-7 w-7" />
