    ...
    <div className="flex flex-col h-full">
      <div className="flex flex-col gap-4 overflow-y-auto pr-2 pb-4 scrollbar-thin lg:max-h-[calc(100vh-140px)]">
        {videos.map((video, idx) => (
          <div
            key={video.id}
            className="group relative flex cursor-pointer gap-3 rounded-xl p-2 transition-all hover:bg-white hover:shadow-md border border-transparent hover:border-gray-100"
          >
            {/* Thumbnail */}
