...
function ErrorPageContent() {
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-lg mb-8">
          Please wait while we check your donation status.
        </p>
      </div>
    );
  }
  ...
  if (verificationStatus === "success") {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
        ...
        <p className="text-xl text-gray-600 max-w-lg mb-8">
          Your donation was successfully received despite landing on this page.
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-4 text-center">
      ...
      <p className="text-xl text-gray-600 max-w-lg mb-8">
        {errorMessage ||
          "We were unable to process your donation. Please check your payment details and try again."}
      </p>
