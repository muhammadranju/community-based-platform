  ...
  return (
    <div className="w-full">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        <h1 className="text-3xl font-bold text-teal-900">Database</h1>
        ...
        <div className="flex gap-3">
          ...
          >
            <List size={16} /> View Waiting List
          </Link>
          <DropdownMenu>
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-teal-900 text-white text-left">
                ...
                <th className="py-4 px-6 font-medium text-sm whitespace-nowrap text-center">
                  Available
                </th>
                <th className="py-4 px-6 font-medium text-sm whitespace-nowrap text-right">
                  Manage
                </th>
              </tr>
            </thead>
                ...
                {currentItems.length === 0 ? (
                  ...
                  currentItems.map((item, idx) => (
                    ...
                    >
                      ...
                      <td className="py-4 px-6 capitalize whitespace-nowrap">
                        {item.role}
                      </td>
                      <td className="py-4 px-6 whitespace-nowrap">
                        <span
