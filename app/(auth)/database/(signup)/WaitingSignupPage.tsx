          ...
          <div className="lg:col-span-8 pt-4 lg:pl-4">
            <div className="max-w-3xl">
              ...
              <p className="text-gray-600 text-lg mb-12 font-light leading-relaxed max-w-2xl">
                ...
                currently accepting applications for our next batch of designs.
                If you are interested in joining our database, please fill out
                the form below.
              </p>
